...
Here we provide links to the specific sections we recommend using, as well as examples of where you could integrate the software tracks. 
...
Instead, we've provided a short [example lesson](./shell_script_example.md) demonstrating a simple shell script.

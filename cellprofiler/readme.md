...
| ------------- | ------------- |
| move_dataset_files_hardcode.sh | Shell Script to download and install CellProfiler environment  |
| move_dataset_files_parameter.sh  | Shell Script to download and install CellProfiler environment  |
...
| CellProfiler_Single_Set.sh | Shell Script to download and install CellProfiler environment  |
| job_submission_script.sh  | Shell Script to download and install CellProfiler environment  |
| CP4_task_script.sh | Shell Script to download and install CellProfiler environment  |
| Simple_Segmentation.cppipe  | Shell Script to download and install CellProfiler environment  |
| Simple_Segmentation.cpproj  | Shell Script to download and install CellProfiler environment  |
